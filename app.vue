...
<template>
  <header class="header">
    <a class="header__title" href="https://arret-sur-image.fr">
      <img src="@/logo.png" alt="Logo" width="200" style="margin-top: 5px;" />
    </a>
    <a href="https://arret-sur-image.fr" class="return">
      Decouvrir ASI
  ...
  <footer class="footer">
    <p> © {{ year }} {{ Site.name }}. Tous droits réservés.
    </p>
  </footer>
</template>
